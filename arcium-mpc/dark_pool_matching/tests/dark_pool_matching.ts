...
import { DarkPoolMatching } from "../target/types/dark_pool_matching";
...
describe("DarkPoolMatching", () => {
  // Configure the client to use the local cluster.
  anchor.setProvider(anchor.AnchorProvider.env());
  const program = anchor.workspace
    .DarkPoolMatching as Program<DarkPoolMatching>;
  ...
  async function initAddTogetherCompDef(
    program: Program<DarkPoolMatching>,
